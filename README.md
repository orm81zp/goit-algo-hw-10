...
Як видно з результатів тесту, значення має тенденцію наближатися до очікуваного значення, коли кількість експериментів та вибіркових даних стає більше. У даному випадку при кількості точок від 30000 результат методу Монте-Карло є більш наближеним до очікуваного значення.
